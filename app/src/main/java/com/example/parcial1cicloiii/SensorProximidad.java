        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getPosition()==0){
                    Intent siga = new Intent(SensorProximidad.this, Sensores.class);
                    startActivity(siga);
                }
                ...
                if(tab.getPosition()==2){
                    Intent siga = new Intent(SensorProximidad.this, com.example.parcial1cicloiii.Ascelerometro.class);
                    startActivity(siga);
                }
